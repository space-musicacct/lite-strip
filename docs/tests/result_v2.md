...
## ContentExtractor (7 tests) — NEW in v2

| # | Test | Result |
|---|------|--------|
| 1 | Default extracts body only | PASS |
| 2 | More includes head | PASS |
| 3 | Preserves header element | PASS |
| 4 | Preserves footer element | PASS |
| 5 | Preserves nav element | PASS |
| 6 | Returns original when no body | PASS |
| 7 | More returns same as input | PASS |
...
## TimezoneValidation (16 tests) — NEW in v2

### Valid Timezones (8 tests)

| # | Test | Result |
|---|------|--------|
| 1 | UTC | PASS |
| 2 | Asia/Tokyo | PASS |
| 3 | America/New_York | PASS |
| 4 | Europe/London | PASS |
| 5 | Pacific/Auckland | PASS |
| 6 | America/Los_Angeles | PASS |
| 7 | Asia/Shanghai | PASS |
| 8 | Europe/Berlin | PASS |
...
|---|------|--------|
| 1 | Empty string | PASS |
| 2 | Random string | PASS |
| 3 | Partial ("Asia/") | PASS |
| 4 | Numeric ("12345") | PASS |
| 5 | SQL injection attempt | PASS |
| 6 | XSS attempt | PASS |
...
| # | Test | Result |
|---|------|--------|
| 1 | Timezone affects output (UTC vs Asia/Tokyo offset) | PASS |
| 2 | Null timezone falls back to default | PASS |
...
|---|---|---|
| Tests | 106 | 129 (+23) |
| Assertions | 145 | 174 (+29) |
| Test suites | 5 | 7 (+2) |
| New: ContentExtractor | - | 7 tests |
| New: TimezoneValidation | - | 16 tests |
| UrlValidator | expectExceptionMessage (deprecated) | try-catch + assertStringContainsString |
